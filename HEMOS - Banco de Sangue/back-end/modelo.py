...
if __name__ == "__main__":
    ...
    senha = "aninha1234", altura = 1.65, peso = 50, idade = 17, endereco = "Rua imaginária", numero = 39, complemento = " ", cep = 8002258, cidade = "Blumenau", uf = "SC", nomeSocial = " ", telefoneCelular = 991285589, telefoneResidencial = 33333333, tipo_sanguineo = "O", fator_rh = "-")    
